									...
									react_jsx_runtime.jsxs("div", {
										...
										children: [
											...
											react_jsx_runtime.jsxs("div", {
												...
												children: [
													!book.exists ? `${t("shelf.broken", { name: book.title })}` :
													book.chapterTitle ? `${t("shelf.lastRead")} · ${book.chapterTitle} · ${formatReadTime(book.lastReadAt)}` : `${t("shelf.lastRead")} · ${formatReadTime(book.lastReadAt)}`
												]
											})
										]
									}),
